...
| Тариф | Цена (в месяц) | Описание |
|-------|----------------|----------|
| **BASIC** | Бесплатно | Базовые функции с ограничениями |
| **PRO** | от $2.50/мес (при оплате за год) | Для профессионалов |
| **BUSINESS** | от $7.50/мес (при оплате за год) | Полный функционал для бизнеса |

### Периоды оплаты
- **3 месяца**: PRO $5.00/мес ($15 всего), BUSINESS $14.25/мес ($42.75 всего)
- **6 месяцев**: PRO $3.50/мес ($21 всего) -30%, BUSINESS $10.50/мес ($63 всего) -30%
- **12 месяцев**: PRO $2.50/мес ($30 всего) -50%, BUSINESS $7.50/мес ($90 всего) -50%

### Free tier ограничения
| Функция | Free | PRO | BUSINESS |
|---------|------|-----|----------|
| Блоки | До 5 | Безлимит | Безлимит |
| AI-запросы | 3/неделя | Безлимит | Безлимит |
| Темы | Базовые | Все | Все + white-label |
| Аналитика | ❌ | ✅ | ✅ |
| GIF-аватары | ❌ | ✅ | ✅ |
| Водяной знак | Есть | Нет | Нет |
| CRM | ❌ | До 100 лидов/мес | Безлимит |
| Кастомный домен | ❌ | ❌ | ✅ |
...
| **Multi-page** | Внутренние страницы |
...
- [x] Freemium система с 3 тарифами
